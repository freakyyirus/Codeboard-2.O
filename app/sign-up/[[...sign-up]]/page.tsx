                ...
                <div className="relative z-10 flex items-center justify-center w-full p-8">
                    <div className="max-w-md w-full">
                        <motion.div
                            ...
                            className="mb-8"
                        >
                            <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Join CodeBoard</h2>
                            <p className="text-gray-500 text-sm">Start your premium coding journey today.</p>
                        </motion.div>
